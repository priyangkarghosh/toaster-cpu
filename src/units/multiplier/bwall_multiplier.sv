...
module bwall_multiplier (
    ...
    csa #(69) csa6(.a(69'(signed'(ws1))), .b(wc1), .cin(69'(signed'(ws2))), .s(ws6), .cout(wc6));
    csa #(69) csa7(.a(wc2), .b(69'(signed'(ws3))), .cin(wc3), .s(ws7), .cout(wc7));
    csa #(69) csa8(.a(69'(signed'(ws4))), .b(wc4), .cin(69'(signed'(ws5))), .s(ws8), .cout(wc8));
    csa #(69) csa9(.a(wc5), .b(69'(signed'(wp))), .cin(69'(signed'(wq))), .s(ws9), .cout(wc9));
    
    // > layer 3
    logic [69:0] ws10, ws11;
    logic [70:0] wc10, wc11;
    csa #(70) csa10(.a(70'(signed'(ws6))), .b(wc6), .cin(70'(signed'(ws7))), .s(ws10), .cout(wc10));
    csa #(70) csa11(.a(wc7), .b(70'(signed'(ws8))), .cin(wc8), .s(ws11), .cout(wc11));
    
    // > layer 4
    logic [70:0] ws12, ws13;
    logic [71:0] wc12, wc13;
    csa #(71) csa12(.a(71'(signed'(ws10))), .b(wc10), .cin(71'(signed'(ws11))), .s(ws12), .cout(wc12));
    csa #(71) csa13(.a(wc11), .b(71'(signed'(ws9))), .cin({1'b0, wc9}), .s(ws13), .cout(wc13));
    
    // > layer 5
    logic [71:0] ws14;
    logic [72:0] wc14;
    csa #(72) csa14(.a(72'(signed'(ws12))), .b(wc12), .cin(72'(signed'(ws13))), .s(ws14), .cout(wc14));
    
    // > layer 6
    logic [72:0] ws15;
    logic [73:0] wc15;
    csa #(73) csa15(.a(73'(signed'(ws14))), .b(wc14), .cin({1'b0, wc13}), .s(ws15), .cout(wc15));
    ...
    // stage 3 (final sum)
    wire [73:0] final_sum = {s2_s[72], s2_s} + s2_c;
    always_ff @(posedge clk) begin
